                    ...
                    <form className='space-y-4' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className='flex items-center justify-between rounded-lg border p-3'>
                            <div className='space-y-0.5'>
                                ...
                                <p className='text-sm text-muted-foreground'>This account will be selected by deafult for transactions</p>
                            </div>
                            <Switch id="isDefault" onCheckedChange={(value) => setValue("isDefault", value)} checked={watch("isDefault")} />
                        </div>
